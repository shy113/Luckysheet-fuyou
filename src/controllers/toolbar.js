...
export const toolbarIdMap = {
  ...
  importExcel: '#luckysheet-icon-importExcel',
  exportExcel: '#luckysheet-icon-exportExcel',
};
...
export function createToolbarHtml() {
  ...
  const htmlMap = {
                ...
                style="user-select: none;">
                    ...
                    style="user-select: none;">
                        <div class="luckysheet-icon luckysheet-inline-block " style="user-select: none;">
                            ...
                            style="user-select: none;">
                            <svg t="1721312145194" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3629" width="18" height="18"><path d="M768.7168 365.9264c-15.9232-125.6448-123.136-222.8224-253.0816-222.8224S278.4256 240.2816 262.5024 365.9264c-116.1216 25.088-203.1616 128.3072-203.1616 251.9552 0 142.3872 115.456 257.8432 257.8432 257.8432h396.9024c142.3872 0 257.8432-115.456 257.8432-257.8432-0.0512-123.5968-87.0912-226.8672-203.2128-251.9552z" fill="#FF5D50" p-id="3630"></path><path d="M591.872 571.5968v189.8496c0 15.104-12.2368 27.3408-27.3408 27.3408H466.688c-15.104 0-27.3408-12.2368-27.3408-27.3408v-189.8496H352.0512c-23.9616 0-36.352-28.6208-19.9168-46.08l163.5328-174.2336a27.33568 27.33568 0 0 1 39.8848 0l163.5328 174.2336c16.384 17.4592 3.9936 46.08-19.9168 46.08H591.872z" fill="#FFDF99" p-id="3631"></path></svg>
                            <!--限制上传格式为xls和xslx-->
    ...
    exportExcel:`<div class="luckysheet-toolbar-button-split-left luckysheet-toolbar-button luckysheet-inline-block"
        data-tips="${toolbar.exportExcel}" id="luckysheet-icon-exportExcel" role="button" style="user-select: none;">
            <div class="luckysheet-toolbar-button-outer-box luckysheet-inline-block"
            style="user-select: none;">
                <div class="luckysheet-toolbar-menu-button-inner-box luckysheet-inline-block"
                style="user-select: none;">
                    ...
                    style="user-select: none;">
                        <div class="luckysheet-icon luckysheet-inline-block " style="user-select: none;">
                            <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-none "
                            style="user-select: none;">
                            <svg t="1721311989036" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2542" width="18" height="18"><path d="M764.672 365.9264c-15.9232-125.6448-123.136-222.8224-253.0816-222.8224S274.3808 240.2816 258.4576 365.9264C142.336 391.0144 55.296 494.2848 55.296 617.9328c0 142.3872 115.456 257.8432 257.8432 257.8432h396.9024c142.3872 0 257.8432-115.456 257.8432-257.8432-0.0512-123.648-87.0912-226.9184-203.2128-252.0064z" fill="#1296db" p-id="2543" data-spm-anchor-id="a313x.collections_detail.0.i3.767f3a816zziFZ" class="selected"></path><path d="M587.8272 570.112V380.2624c0-15.104-12.2368-27.3408-27.3408-27.3408H462.6432c-15.104 0-27.3408 12.2368-27.3408 27.3408v189.8496H348.0064c-23.9616 0-36.352 28.6208-19.9168 46.08l163.5328 174.2336a27.33568 27.33568 0 0 0 39.8848 0l163.5328-174.2336c16.384-17.4592 3.9936-46.08-19.9168-46.08h-87.296z" fill="#fcfcfc" p-id="2544" data-spm-anchor-id="a313x.collections_detail.0.i1.767f3a816zziFZ" class=""></path></svg>
                             <div id="luckysheet-excelDownload"></div>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  if (getObjType(showtoolbarConfig) === 'array') {
    ...
    showtoolbarConfig.forEach(function(key, i) {
      if (key === '|') {
        ...
        if (nameKeys !== '|') {
          buttonHTML.push(`<div id="toolbar-separator-${camel2split(nameKeys)}" class="luckysheet-toolbar-separator luckysheet-inline-block" style="user-select: none;"></div>`);
        }
      } else {
