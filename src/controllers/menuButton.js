...
const menuButton = {
  ...
  initialMenuButton: function() {
    ...
    // exportExcel
    $('#luckysheet-icon-exportExcel').click(function() {
      $('#luckysheet-excelDownload').click();
    });
    ...
    $('#luckysheet-icon-text-color-menu')
      ...
      .click(function() {
        ...
        if ($menuButton.length == 0) {
          ...
          let itemdata = [{ name: locale_toolbar.alternatingColors + '...', id: 'luckysheet-color-alternate', example: '' }];
    ...
    $('#luckysheet-icon-conditionformat').click(function() {
      ...
      if ($menuButton.length == 0) {
        ...
        $(document)
          ...
          .on('click.CFhighlightCellRule', '#luckysheet-icon-highlightCellRule-menuButton .luckysheet-cols-menuitem', function() {
            $menuButton.hide();
        ...
        $(document)
          ...
          .on('click.CFprojectSelectRule', '#luckysheet-icon-projectSelectRule-menuButton .luckysheet-cols-menuitem', function() {
            $menuButton.hide();
        ...
        $(document)
          ...
          .on('click.CFcolorGradation', '#luckysheet-icon-colorGradation-menuButton .luckysheet-cols-menuitem', function() {
            $menuButton.hide();
        ...
        $(document)
          ...
          .on('click.CFdeleteRule', '#luckysheet-icon-deleteRule-menuButton .luckysheet-cols-menuitem', function() {
            $menuButton.hide();
